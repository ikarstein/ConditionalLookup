...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="New2.aspx.cs" Inherits="ik.SharePoint2010.ConditionalLookup.Layouts.ConditionalLookup.New2"
    MasterPageFile="" %>
<%@ Assembly Name="Microsoft.Web.CommandUI, Version=14.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
                                    ...
                                    <table border="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td width="400px" valign="top" class="ms-formbody">
                                                <SharePoint:FormField runat="server" ID="ff1" ControlMode="New" FieldName="List2RefToList1FieldA" />
                                        ...
                                        <tr>
                                            ...
                                            <td width="400px" valign="top" class="ms-formbody">
                                                <SharePoint:FormField runat="server" ID="ff2" ControlMode="New" FieldName="List2RefToList3FieldA"/>
